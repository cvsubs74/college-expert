...
import { TrashIcon, ChevronDownIcon, ChevronUpIcon, PencilSquareIcon, ClipboardDocumentIcon, CheckIcon, BookmarkIcon } from '@heroicons/react/24/outline';
    ...
    <div data-testid="research-workflow" className="mt-3 rounded-lg border border-gray-100 bg-gray-50/60 p-3">
      <div className="flex items-center justify-between gap-2">
        ...
        <div className="flex flex-wrap items-center justify-end gap-1.5">
          <AgentLaunchButtons links={links} verb="Run" size="xs" />
