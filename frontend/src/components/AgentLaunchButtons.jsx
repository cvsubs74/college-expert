...
// hand a prompt off to. Claude and ChatGPT open a web chat (their web apps run
// the Stratia connector).
const PROVIDERS = [
 ...
 * The first present provider is primary (green) and may carry a verb ("Run in
 * Claude"); the rest are compact outlines. Renders only providers that have a
 * link; the parent supplies the flex container.
 *
