...
## 2026-06-14 — Collapsible left sidebar navigation (#231, PR #232, in review)
...
- Verify: npm run build OK; 259 frontend tests pass (38 files). PR #232 (Closes #231); CI pending.
